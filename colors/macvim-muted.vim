" MacVim-Muted colorscheme
"
" Maintainer:   Chris Galtenberg <galtenbergs@gmail.com>
" Originator:   Bjorn Winckler <bjorn.winckler@gmail.com>
"
" Based on the default MacVim color scheme.  It supports both light and dark
...
"
" Change the selection color on focus change (but only if the "macvim-muted"
" colorscheme is active).
"
if has("gui_macvim") && !exists("s:augroups_defined")
  au FocusLost * if exists("colors_name") && colors_name == "macvim-muted" | hi Visual guibg=MacSecondarySelectedControlColor | endif
  au FocusGained * if exists("colors_name") && colors_name == "macvim-muted" | hi Visual guibg=MacSelectedTextBackgroundColor | endif
